...
const projects: Project[] = [
  {
    id: 'project-1',
    title: 'MediaGrid',
    description: 'A modern social media platform built with Next.js and Tailwind CSS.',
    image: '/mediagrid.png',
    ...
    details: 'This social media platform features a responsive design, user authentication, post creation, commenting, and liking. Users can also follow other users and view their feeds. The app uses Firebase for authentication, database, and storage.',
  },
  {
    id: 'project-2',
    title: 'Code Review',
    description: 'An AI-powered code review tool that evaluates snippets and suggests improvements.',
    image: '/codereview.png',
    tags: ['Express js', 'Next.js', 'Tailwind CSS', 'TypeScript', 'Hugging Face'],
    liveUrl: 'https://code-review-one.vercel.app/',
    githubUrl: 'https://github.com/mohith789p/Code-Assistant',
    details: 'AI analyzes code for correctness, efficiency, and readability, provides improvement suggestions with justifications, and gives an overall rating.',
  },
  {
    id: 'project-3',
    title: 'Teacher Assistant',
    description: 'An AI-powered teacher assistant that helps students with their queries and assignments.',
    ...
    details: 'This teacher assistant features a responsive design, user authentication, and a chat interface. Users can ask questions and get instant responses. The app uses Next.js for the frontend, and Firebase for authentication and database.',
  },
  {
    id: 'project-4',
    title: 'Book Search',
    description: 'A book search application with book details and recommendations.',
    image: '/booksearch.png',
    tags: ['HTML', 'CSS', 'EJS'],
    liveUrl: 'https://book-search-puce.vercel.app/',
    githubUrl: 'https://github.com/mohith789p/book-search',
    details: 'This book search application allows users to search for books using the Open Library API. Users can view book details, including cover images, author, and publication year. The app also provides a recommendations section based on user search history.',
  },
  {
    id: 'project-5',
    ...
    githubUrl: 'https://github.com/mohith789p/Telegram-Bot/tree/main/Weather%20Bot',
    details: 'This Telegram bot fetches weather information for any city and delivers it directly in chat.',
  },
  {
    id: 'project-6',
    title: 'GenPic Bot',
    ...
    githubUrl: 'https://github.com/mohith789p/Telegram-Bot/tree/main/PicGeneration%20Bot',
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/mohith789p/Telegram-Bot/tree/main/Checklist%20Bot',
    details: 'This Telegram bot allows users to create, update, and manage checklists directly within Telegram.',
  },
  {
    id: 'project-8',
    ...
    githubUrl: 'https://github.com/mohith789p/Telegram-Bot/tree/main/TrainStatus%20Bot',
    details: 'This Telegram bot provides real-time train running status and updates.',
  },
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-card-foreground mb-6">{selectedProject.details}</p>
