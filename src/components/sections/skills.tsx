...
const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: 'Next.js', icon: '▲', description: 'Server-side rendering & routing' },
  ...
  },
  {
    title: 'AI & Embedded',
    skills: [
      { name: 'Arduino (C/C++)', icon: '🔌', description: 'Microcontroller programming' },
      { name: 'Raspberry Pi', icon: '🍓', description: 'Embedded computing' },
      { name: 'NVIDIA Jetson Nano', icon: '🖥️', description: 'AI acceleration' },
  ...
  skills: [
    { name: 'Python', icon: '🐍', description: 'Programming for AI & data analysis' },
    ...
    { name: 'Seaborn', icon: '🌊', description: 'Statistical plotting & visualization' },
    { name: 'OpenCV', icon: '📷', description: 'Computer vision projects' },
    { name: 'Hugging Face', icon: '🤗', description: 'Running AI/ML models via APIs' }
  ]
},
  {
    title: 'Tools & Others',
  ...
  { name: 'GitHub', icon: '🐙', description: 'Code hosting & collaboration' },
  { name: 'Hugging Face', icon: '🤗', description: 'Running AI/ML models via APIs' },
  { name: 'Google Colab', icon: '☁️', description: 'Cloud-based Python notebooks' }
    ...
    <section className="container mx-auto px-4 py-16">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          A showcase of my technical expertise across software development, AI, and embedded systems.
        </p>
      </motion.div>
